...
%mirs = xlsread('lung_oncomirsQuaNor_743H2.xlsx')
%H2est>1.2 - 65   113   190   193   204   268   270   271   335   339   359   418   427   444   549   589   606   628   718   736
%H1est>1.2   65   113   190   193   204   268   270   271   335   339   359   418   427   444   549   589   606   628   718   736
%H3est>1.2   65   113   190   193   204   268   270   271   335   339   359   418   427   444   549   589   606   628   718   736

%mirs = xlsread('lung_oncomirs_medNor_742H1.xlsx')
%mirs = xlsread('lung_oncomirs_medNor_722H3.xlsx')

%A = xlsread('E:\BioSpyder\Bios2115\BIOS2115_bios2115_MCF7_ART_gene_countsLABELLED.xlsm',2);
%R = xlsread('E:\BioSpyder\Bios2115\BIOS2115_bios2115_MCF7_ART_gene_countsLABELLED.xlsm',3);
%T = xlsread('E:\BioSpyder\Bios2115\BIOS2115_bios2115_MCF7_ART_gene_countsLABELLED.xlsm',4);
%N = xlsread('E:\BioSpyder\Bios2115\BIOS2115_bios2115_MCF7_ART_gene_countsLABELLED.xlsm');
...
%sampP = round(mirs(:,1:13))';
%sampQ = round(mirs(:,14:28))';
sampP = round(C5c)';%R';%A';
sampQ = round(A5)';%T';%R';
